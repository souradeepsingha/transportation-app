...
public class Bokingpage extends AppCompatActivity {
   ...
   Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bokingpage);


        paybtn = findViewById(R.id.paybtn1);
        button=findViewById(R.id.home);
        paybtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String name = "souradeep";
                String upiId = "8927645830@ibl";
                String amt = "10";
                String msg = "";
                ...
                if(name.isEmpty() || upiId.isEmpty()){
                    Toast.makeText(Bokingpage.this, "Name and Upi Id is necessary", Toast.LENGTH_SHORT).show();
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent myintent=new Intent(Bokingpage.this,MainActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == PAY_REQUEST){
            ...
            if(isInternetAvailabe(Bokingpage.this)){
